...
const PrimaryAction = tw.button`px-8 py-3 mt-10 text-sm sm:text-base sm:mt-16 sm:px-8 sm:py-4 bg-gray-100 text-yellow-800 font-bold rounded shadow transition duration-300 hocus:bg-yellow-800 hocus:text-gray-100 hocus:shadow-outline`;
